                ...
                <div class="">
                    ...
                    <tr>
                        ...
                        <td>
                       	...
                       	<td>
                            <a href="{{route('pemesanan.show', $data->id)}}" class="btn btn-xs btn-primary"><span class="fa fa-eye"></span></a>
                            <form id="destroy{{$data->id}}" method="POST" action="{{ route('pemesanan.destroy', $data->id) }}" accept-charset="UTF-8" class="form-delete" style="display: inline-block;">
